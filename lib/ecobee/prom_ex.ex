defmodule Ecobee.PromEx do
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule EcobeeWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :ecobee

       ...

       plug PromEx.Plug, prom_ex_module: Ecobee.PromEx
  ...
  def plugins do
    [
      ...
      # Plugins.Beam,
      Ecobee.PromExPlugin,
      # {Plugins.Phoenix, router: EcobeeWeb.Router, endpoint: EcobeeWeb.Endpoint},
      # Plugins.Ecto,
      # Plugins.Oban,
  ...
  def dashboards do
    [
      ...
      # {:ecobee, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
